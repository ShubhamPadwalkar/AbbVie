...
public class FooterTest extends BaseTest {
	...
	public void testFacebookIcon() {
		ReportUtil.createTest("Click On facebook Icon");
		try {
			footer.clickOnfacebookIcon();
			ReportUtil.logPass("Click on facebook Icon Successful.");
			String screenshotPath = screenshotUtil.takeScreenshot("facebookIcon");
			ReportUtil.attachScreenshot(screenshotPath);
		} catch (Exception e) {
			ReportUtil.logFail("Navigation to Terms of Use page failed: " + e.getMessage());
			try {
				String screenshotPath = screenshotUtil.takeScreenshot("Navigation_failure_facebookIcon");
				ReportUtil.attachScreenshot(screenshotPath);
			} catch (Exception ex) {
				ex.printStackTrace();
			}
    ...
    public void testInstagramIcon() {
        ReportUtil.createTest("Click On Instagram Icon");
        try {
            footer.clickOnInstagramIcon();
            ReportUtil.logPass("Click on Instagram Icon Successful and new tab handled.");
            String screenshotPath = screenshotUtil.takeScreenshot("InstagramIcon");
            ReportUtil.attachScreenshot(screenshotPath);
        } catch (Exception e) {
            ReportUtil.logFail("Click on Instagram icon failed: " + e.getMessage());
            try {
                String screenshotPath = screenshotUtil.takeScreenshot("InstagramIcon_failure");
                ReportUtil.attachScreenshot(screenshotPath);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    @Test(priority = 18)
    public void testLinkdinIcon() {
        ReportUtil.createTest("Click On LinkedIn Icon");
        try {
            footer.clickOnLinkdinIcon();
            ReportUtil.logPass("Click on LinkedIn Icon Successful and new tab handled.");
            String screenshotPath = screenshotUtil.takeScreenshot("LinkedInIcon");
            ReportUtil.attachScreenshot(screenshotPath);
        } catch (Exception e) {
            ReportUtil.logFail("Click on LinkedIn icon failed: " + e.getMessage());
            try {
                String screenshotPath = screenshotUtil.takeScreenshot("LinkedInIcon_failure");
                ReportUtil.attachScreenshot(screenshotPath);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public void testYoutubeIcon() {
        ReportUtil.createTest("Click On YouTube Icon");
        try {
            footer.clickOnYoutubeIcon();
            ReportUtil.logPass("Click on YouTube Icon Successful and new tab handled.");
            String screenshotPath = screenshotUtil.takeScreenshot("YoutubeIcon");
            ReportUtil.attachScreenshot(screenshotPath);
        } catch (Exception e) {
            ReportUtil.logFail("Click on YouTube icon failed: " + e.getMessage());
            try {
                String screenshotPath = screenshotUtil.takeScreenshot("YoutubeIcon_failure");
                ReportUtil.attachScreenshot(screenshotPath);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
